...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">ABOUT OUR SERVICES</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base  text-gray-900"> The saga of Ideal Ice Cream began in the early seventies with the establishment of the mesmeric Ideal Ice Cream Parlour right in the heart of the city by visionary and entrepreneur</p>
    </div>
